...
| | |
|---|---|
| **Estado** | Fases **0–5** hechas. Siguiente: **Fase 6** (densificación). |
...
| **Contratos** | [`001`](specs/001-mvp-mapa-ayuda/) · [`002`](specs/002-registro-facil-lugares/) · [`003`](specs/003-quiero-ayudar-enlace/) · [`004`](specs/004-donacion-descubrimiento-enlace/) |
...
3. **Quiero ayudar** (`/ayudar`) — lugares (acopio, albergue…) y cómo ayudar en su canal.  
