# Decisiones técnicas (índice ADR)

| ADR | Título | Estado |
|-----|--------|--------|
| [0001](0001-producto-y-metodologia.md) | Nombre, metodología SDD, tooling | Aceptada |
| [0002](0002-stack-y-monorepo.md) | Stack y monorepo | Aceptada |
