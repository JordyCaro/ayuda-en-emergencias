...
export const CURATED_HELP_PLACES: CuratedPlaceSeed[] = [
  // —— Nacional / Bogotá ——
  {
    ...
    description: 'Red nacional: sedes, voluntariado y cómo ayudar en su sitio oficial.',
    lat: 4.6486,
    lng: -74.107,
    cityCode: '11001',
    municipality: 'Bogotá',
  ...
  },
  {
    ...
    description: 'Campaña / banco de sangre en Bogotá. Confirma horarios y requisitos en su canal.',
    lat: 4.648,
    lng: -74.084,
    cityCode: '11001',
    municipality: 'Bogotá',
  ...
  // —— Medellín ——
  {
    ...
    description: 'Sede seccional: voluntariado y orientación en Medellín y Antioquia (su sitio).',
    lat: 6.25,
    lng: -75.57,
    cityCode: '05001',
  ...
  },
  {
    ...
    description: 'Llevar comida no perecedera o preguntar por turnos de apoyo en su canal.',
    lat: 3.4516,
    lng: -76.532,
    cityCode: '76001',
    municipality: 'Cali',
  ...
  // —— Pereira ——
  {
    ...
    description: 'Sede en Pereira: voluntariado y orientación en su canal oficial.',
    lat: 4.8143,
    lng: -75.6946,
    cityCode: '66001',
