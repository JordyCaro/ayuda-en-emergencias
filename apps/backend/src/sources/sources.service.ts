...
const DEFAULT_SOURCES: Array<Partial<SourceEntity> & { id: string; name: string }> = [
  ...
  },
  {
    ...
    notes: 'Query features bloqueado en Fase 0. Deep-link al visor oficial (Fase 7 /oficiales).',
  },
  {
    id: 'rnd',
    name: 'RND / SIRDEC — Personas desaparecidas',
    type: 'OFFICIAL',
    tier: 1,
    country: 'CO',
    url: 'https://siclico.medicinalegal.gov.co/consultasPublicas/Desaparecidos.xhtml',
    apiUrl: null,
    license: 'Medicina Legal — solo consulta pública; no redistribuir PII',
    attributionRequired: true,
    updateFrequency: 'UNKNOWN',
    integrationStatus: 'BLOCKED',
    notes:
      'DEEP_LINK only (Fase 7). Nunca base propia de desaparecidos ni scraping SIRDEC.',
  },
  {
    id: 'ungrd',
    ...
    license: 'Datos abiertos / institucional — verificar por dataset',
    attributionRequired: true,
    updateFrequency: 'HISTORICAL',
    integrationStatus: 'DISCOVERY',
    notes: 'Deep-link portal + dataset histórico. No fingir feed en vivo de afectados.',
  },
  {
    id: 'idiger',
    name: 'IDIGER — Bogotá',
    ...
    apiUrl: null,
    license: 'Distrital — revisar CC-BY-NC por capa',
    attributionRequired: true,
    updateFrequency: 'UNKNOWN',
    integrationStatus: 'DISCOVERY',
    notes: 'Deep-link Fase 7. Connectors de capas solo con LEGAL_REVIEW.',
  },
  {
    id: 'sispro',
